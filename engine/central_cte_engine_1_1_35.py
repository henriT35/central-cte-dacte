# -*- coding: utf-8 -*-
"""Ponto de entrada do Central CT-e / DACTE 2.7.0 RC26.5."""
...
from central_cte_modular.rc26_5_runtime_patch import RC26_5_VERSION, install_rc26_5_runtime

CENTRAL_CTE_BOOTSTRAP = bootstrap_engine_facade(globals(), _ENGINE_FILE)
CENTRAL_CTE_RC26_5_STATE = install_rc26_5_runtime(globals(), CENTRAL_CTE_BOOTSTRAP)
